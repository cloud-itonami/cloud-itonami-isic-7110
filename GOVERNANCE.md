...
`cloud-itonami-7110` is an OSS open-business blueprint for community architectural and engineering practice, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Practice Governor remains independent of the advisor.
