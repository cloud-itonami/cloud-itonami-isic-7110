...
- human sign-off for :high/:safety-critical robot actions (e.g. handling stamped/certified drawings and public-works deliverables)
...
## Operating states
intake : scope : design : verify : deliver : audit
