# Operator Quickstart — Community Architectural and Engineering Practice

Shortest path from clone to a verified local dry-run for **ISIC 7110** (`cloud-itonami-isic-7110`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7110.git
cd cloud-itonami-isic-7110
```
...
- Blueprint governor key: `design-governor`
- Likely source path: `practiceops.governor.cljc`
